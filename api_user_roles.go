...
func (r ApiAddUserRoleRequest) CreateUserRoleRequest(createUserRoleRequest CreateUserRoleRequest) ApiAddUserRoleRequest {
	r.createUserRoleRequest = &createUserRoleRequest
	return r
}

func (r ApiAddUserRoleRequest) Execute() (*CreateUserRoleResponse, *http.Response, error) {
...
func (a *UserRolesAPIService) AddUserRoleExecute(r ApiAddUserRoleRequest) (*CreateUserRoleResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/org-units/{orgUnitId}/user-roles"
	...
	if r.createUserRoleRequest == nil {
		return localVarReturnValue, nil, reportError("createUserRoleRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createUserRoleRequest
...
func (r ApiGetUserRoleRequest) Execute() (*UserRoleDetailsResponse, *http.Response, error) {
...
func (a *UserRolesAPIService) GetUserRoleExecute(r ApiGetUserRoleRequest) (*UserRoleDetailsResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/org-units/{orgUnitId}/user-roles/{userRoleId}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgUnitId"+"}", url.PathEscape(parameterValueToString(r.orgUnitId, "orgUnitId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"userRoleId"+"}", url.PathEscape(parameterValueToString(r.userRoleId, "userRoleId")), -1)
...
func (r ApiListUserRolesRequest) Select_(select_ string) ApiListUserRolesRequest {
	r.select_ = &select_
	return r
}

// The name of a field to sort the result by.
func (r ApiListUserRolesRequest) SortBy(sortBy string) ApiListUserRolesRequest {
	r.sortBy = &sortBy
	return r
}

// The order in which the result will follow -- case insensitive and default to ASC.
func (r ApiListUserRolesRequest) SortOrder(sortOrder string) ApiListUserRolesRequest {
	r.sortOrder = &sortOrder
	return r
}

func (r ApiListUserRolesRequest) Execute() (*QueryResponseUserRole, *http.Response, error) {
