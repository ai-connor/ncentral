...
// checks if the DevicePropertyUpdated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DevicePropertyUpdated{}
...
func NewDevicePropertyUpdated() *DevicePropertyUpdated {
	this := DevicePropertyUpdated{}
	return &this
}

// NewDevicePropertyUpdatedWithDefaults instantiates a new DevicePropertyUpdated object
...
type NullableDevicePropertyUpdated struct {
	value *DevicePropertyUpdated
	isSet bool
}

func (v NullableDevicePropertyUpdated) Get() *DevicePropertyUpdated {
	return v.value
}

func (v *NullableDevicePropertyUpdated) Set(val *DevicePropertyUpdated) {
	v.value = val
	v.isSet = true
}

func (v NullableDevicePropertyUpdated) IsSet() bool {
	return v.isSet
}
...
func NewNullableDevicePropertyUpdated(val *DevicePropertyUpdated) *NullableDevicePropertyUpdated {
	return &NullableDevicePropertyUpdated{value: val, isSet: true}
}
