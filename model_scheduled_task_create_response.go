...
// checks if the ScheduledTaskCreateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduledTaskCreateResponse{}
...
type _ScheduledTaskCreateResponse ScheduledTaskCreateResponse

// NewScheduledTaskCreateResponse instantiates a new ScheduledTaskCreateResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewScheduledTaskCreateResponse() *ScheduledTaskCreateResponse {
	this := ScheduledTaskCreateResponse{}
	return &this
}

// NewScheduledTaskCreateResponseWithDefaults instantiates a new ScheduledTaskCreateResponse object
...
func (o *ScheduledTaskCreateResponse) GetData() TaskCreate {
...
func (o *ScheduledTaskCreateResponse) SetData(v TaskCreate) {
	o.Data = &v
}
...
func (o *ScheduledTaskCreateResponse) UnmarshalJSON(data []byte) (err error) {
	varScheduledTaskCreateResponse := _ScheduledTaskCreateResponse{}

	err = json.Unmarshal(data, &varScheduledTaskCreateResponse)

	if err != nil {
		return err
	}

	*o = ScheduledTaskCreateResponse(varScheduledTaskCreateResponse)
...
type NullableScheduledTaskCreateResponse struct {
	value *ScheduledTaskCreateResponse
	isSet bool
}

func (v NullableScheduledTaskCreateResponse) Get() *ScheduledTaskCreateResponse {
	return v.value
}

func (v *NullableScheduledTaskCreateResponse) Set(val *ScheduledTaskCreateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduledTaskCreateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduledTaskCreateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduledTaskCreateResponse(val *ScheduledTaskCreateResponse) *NullableScheduledTaskCreateResponse {
	return &NullableScheduledTaskCreateResponse{value: val, isSet: true}
}
