...
// checks if the ScheduledTaskInfoResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduledTaskInfoResponse{}
...
func NewScheduledTaskInfoResponse() *ScheduledTaskInfoResponse {
	this := ScheduledTaskInfoResponse{}
	return &this
}

// NewScheduledTaskInfoResponseWithDefaults instantiates a new ScheduledTaskInfoResponse object
...
type NullableScheduledTaskInfoResponse struct {
	value *ScheduledTaskInfoResponse
	isSet bool
}

func (v NullableScheduledTaskInfoResponse) Get() *ScheduledTaskInfoResponse {
	return v.value
}

func (v *NullableScheduledTaskInfoResponse) Set(val *ScheduledTaskInfoResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduledTaskInfoResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduledTaskInfoResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduledTaskInfoResponse(val *ScheduledTaskInfoResponse) *NullableScheduledTaskInfoResponse {
	return &NullableScheduledTaskInfoResponse{value: val, isSet: true}
}
