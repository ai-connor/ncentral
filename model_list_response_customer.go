...
// checks if the ListResponseCustomer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListResponseCustomer{}
...
func NewListResponseCustomer() *ListResponseCustomer {
	this := ListResponseCustomer{}
	return &this
}

// NewListResponseCustomerWithDefaults instantiates a new ListResponseCustomer object
...
type NullableListResponseCustomer struct {
	value *ListResponseCustomer
	isSet bool
}

func (v NullableListResponseCustomer) Get() *ListResponseCustomer {
	return v.value
}

func (v *NullableListResponseCustomer) Set(val *ListResponseCustomer) {
	v.value = val
	v.isSet = true
}

func (v NullableListResponseCustomer) IsSet() bool {
	return v.isSet
}
...
func NewNullableListResponseCustomer(val *ListResponseCustomer) *NullableListResponseCustomer {
	return &NullableListResponseCustomer{value: val, isSet: true}
}
