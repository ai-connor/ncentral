...
// checks if the ListResponseServiceOrganization type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListResponseServiceOrganization{}
...
type _ListResponseServiceOrganization ListResponseServiceOrganization

// NewListResponseServiceOrganization instantiates a new ListResponseServiceOrganization object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListResponseServiceOrganization() *ListResponseServiceOrganization {
	this := ListResponseServiceOrganization{}
	return &this
}

// NewListResponseServiceOrganizationWithDefaults instantiates a new ListResponseServiceOrganization object
...
func (o *ListResponseServiceOrganization) GetData() []ServiceOrganization {
...
func (o *ListResponseServiceOrganization) GetDataOk() ([]ServiceOrganization, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *ListResponseServiceOrganization) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
func (o *ListResponseServiceOrganization) SetData(v []ServiceOrganization) {
	o.Data = v
}
...
func (o *ListResponseServiceOrganization) UnmarshalJSON(data []byte) (err error) {
	varListResponseServiceOrganization := _ListResponseServiceOrganization{}

	err = json.Unmarshal(data, &varListResponseServiceOrganization)

	if err != nil {
		return err
	}

	*o = ListResponseServiceOrganization(varListResponseServiceOrganization)
...
type NullableListResponseServiceOrganization struct {
	value *ListResponseServiceOrganization
	isSet bool
}

func (v NullableListResponseServiceOrganization) Get() *ListResponseServiceOrganization {
	return v.value
}

func (v *NullableListResponseServiceOrganization) Set(val *ListResponseServiceOrganization) {
	v.value = val
	v.isSet = true
}

func (v NullableListResponseServiceOrganization) IsSet() bool {
	return v.isSet
}

func (v *NullableListResponseServiceOrganization) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListResponseServiceOrganization(val *ListResponseServiceOrganization) *NullableListResponseServiceOrganization {
	return &NullableListResponseServiceOrganization{value: val, isSet: true}
}
