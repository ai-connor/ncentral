...
// checks if the ListResponseDetailsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListResponseDetailsResponse{}
...
type _ListResponseDetailsResponse ListResponseDetailsResponse

// NewListResponseDetailsResponse instantiates a new ListResponseDetailsResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListResponseDetailsResponse() *ListResponseDetailsResponse {
	this := ListResponseDetailsResponse{}
	return &this
}

// NewListResponseDetailsResponseWithDefaults instantiates a new ListResponseDetailsResponse object
...
func (o *ListResponseDetailsResponse) GetData() []DetailsResponse {
	if o == nil || IsNil(o.Data) {
		var ret []DetailsResponse
		return ret
	}
	return o.Data
}
...
func (o *ListResponseDetailsResponse) SetData(v []DetailsResponse) {
	o.Data = v
}
...
func (o *ListResponseDetailsResponse) UnmarshalJSON(data []byte) (err error) {
	varListResponseDetailsResponse := _ListResponseDetailsResponse{}

	err = json.Unmarshal(data, &varListResponseDetailsResponse)

	if err != nil {
		return err
	}

	*o = ListResponseDetailsResponse(varListResponseDetailsResponse)
...
type NullableListResponseDetailsResponse struct {
	value *ListResponseDetailsResponse
	isSet bool
}

func (v NullableListResponseDetailsResponse) Get() *ListResponseDetailsResponse {
	return v.value
}

func (v *NullableListResponseDetailsResponse) Set(val *ListResponseDetailsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListResponseDetailsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListResponseDetailsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListResponseDetailsResponse(val *ListResponseDetailsResponse) *NullableListResponseDetailsResponse {
	return &NullableListResponseDetailsResponse{value: val, isSet: true}
}
