...
// checks if the ListResponseDeviceCustomProperty type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListResponseDeviceCustomProperty{}
...
type _ListResponseDeviceCustomProperty ListResponseDeviceCustomProperty

// NewListResponseDeviceCustomProperty instantiates a new ListResponseDeviceCustomProperty object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListResponseDeviceCustomProperty() *ListResponseDeviceCustomProperty {
	this := ListResponseDeviceCustomProperty{}
	return &this
}

// NewListResponseDeviceCustomPropertyWithDefaults instantiates a new ListResponseDeviceCustomProperty object
...
func (o *ListResponseDeviceCustomProperty) GetData() []DeviceCustomProperty {
	if o == nil || IsNil(o.Data) {
		var ret []DeviceCustomProperty
		return ret
	}
	return o.Data
}
...
func (o *ListResponseDeviceCustomProperty) GetDataOk() ([]DeviceCustomProperty, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *ListResponseDeviceCustomProperty) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
func (o *ListResponseDeviceCustomProperty) SetData(v []DeviceCustomProperty) {
	o.Data = v
}
...
func (o *ListResponseDeviceCustomProperty) UnmarshalJSON(data []byte) (err error) {
	varListResponseDeviceCustomProperty := _ListResponseDeviceCustomProperty{}

	err = json.Unmarshal(data, &varListResponseDeviceCustomProperty)

	if err != nil {
		return err
	}

	*o = ListResponseDeviceCustomProperty(varListResponseDeviceCustomProperty)
...
type NullableListResponseDeviceCustomProperty struct {
	value *ListResponseDeviceCustomProperty
	isSet bool
}

func (v NullableListResponseDeviceCustomProperty) Get() *ListResponseDeviceCustomProperty {
	return v.value
}

func (v *NullableListResponseDeviceCustomProperty) Set(val *ListResponseDeviceCustomProperty) {
	v.value = val
	v.isSet = true
}

func (v NullableListResponseDeviceCustomProperty) IsSet() bool {
	return v.isSet
}

func (v *NullableListResponseDeviceCustomProperty) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListResponseDeviceCustomProperty(val *ListResponseDeviceCustomProperty) *NullableListResponseDeviceCustomProperty {
	return &NullableListResponseDeviceCustomProperty{value: val, isSet: true}
}

func (v NullableListResponseDeviceCustomProperty) MarshalJSON() ([]byte, error) {
