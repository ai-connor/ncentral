...
// checks if the OrgUnitCustomPropertyModification type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrgUnitCustomPropertyModification{}
...
func NewOrgUnitCustomPropertyModification() *OrgUnitCustomPropertyModification {
	this := OrgUnitCustomPropertyModification{}
	return &this
}

// NewOrgUnitCustomPropertyModificationWithDefaults instantiates a new OrgUnitCustomPropertyModification object
...
func (o *OrgUnitCustomPropertyModification) GetValue() string {
...
func (o *OrgUnitCustomPropertyModification) HasValue() bool {
	if o != nil && !IsNil(o.Value) {
		return true
	}
...
func (o *OrgUnitCustomPropertyModification) SetValue(v string) {
	o.Value = &v
}
...
type NullableOrgUnitCustomPropertyModification struct {
	value *OrgUnitCustomPropertyModification
	isSet bool
}

func (v NullableOrgUnitCustomPropertyModification) Get() *OrgUnitCustomPropertyModification {
	return v.value
}

func (v *NullableOrgUnitCustomPropertyModification) Set(val *OrgUnitCustomPropertyModification) {
	v.value = val
	v.isSet = true
}

func (v NullableOrgUnitCustomPropertyModification) IsSet() bool {
	return v.isSet
}

func (v *NullableOrgUnitCustomPropertyModification) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrgUnitCustomPropertyModification(val *OrgUnitCustomPropertyModification) *NullableOrgUnitCustomPropertyModification {
	return &NullableOrgUnitCustomPropertyModification{value: val, isSet: true}
}

func (v NullableOrgUnitCustomPropertyModification) MarshalJSON() ([]byte, error) {
