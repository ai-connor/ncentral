...
// checks if the ListResponseDeviceServiceMonitoringStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListResponseDeviceServiceMonitoringStatus{}
...
func NewListResponseDeviceServiceMonitoringStatus() *ListResponseDeviceServiceMonitoringStatus {
	this := ListResponseDeviceServiceMonitoringStatus{}
	return &this
}

// NewListResponseDeviceServiceMonitoringStatusWithDefaults instantiates a new ListResponseDeviceServiceMonitoringStatus object
...
func (o *ListResponseDeviceServiceMonitoringStatus) GetData() []DeviceServiceMonitoringStatus {
	if o == nil || IsNil(o.Data) {
		var ret []DeviceServiceMonitoringStatus
		return ret
	}
	return o.Data
}
...
func (o *ListResponseDeviceServiceMonitoringStatus) GetDataOk() ([]DeviceServiceMonitoringStatus, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *ListResponseDeviceServiceMonitoringStatus) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
func (o *ListResponseDeviceServiceMonitoringStatus) SetData(v []DeviceServiceMonitoringStatus) {
	o.Data = v
}

// GetTotalItems returns the TotalItems field value if set, zero value otherwise.
func (o *ListResponseDeviceServiceMonitoringStatus) GetTotalItems() int32 {
...
func (o *ListResponseDeviceServiceMonitoringStatus) HasTotalItems() bool {
	if o != nil && !IsNil(o.TotalItems) {
		return true
	}
...
func (o *ListResponseDeviceServiceMonitoringStatus) SetTotalItems(v int32) {
	o.TotalItems = &v
}

func (o ListResponseDeviceServiceMonitoringStatus) MarshalJSON() ([]byte, error) {
...
type NullableListResponseDeviceServiceMonitoringStatus struct {
	value *ListResponseDeviceServiceMonitoringStatus
	isSet bool
}

func (v NullableListResponseDeviceServiceMonitoringStatus) Get() *ListResponseDeviceServiceMonitoringStatus {
	return v.value
}

func (v *NullableListResponseDeviceServiceMonitoringStatus) Set(val *ListResponseDeviceServiceMonitoringStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableListResponseDeviceServiceMonitoringStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableListResponseDeviceServiceMonitoringStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListResponseDeviceServiceMonitoringStatus(val *ListResponseDeviceServiceMonitoringStatus) *NullableListResponseDeviceServiceMonitoringStatus {
	return &NullableListResponseDeviceServiceMonitoringStatus{value: val, isSet: true}
}

func (v NullableListResponseDeviceServiceMonitoringStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListResponseDeviceServiceMonitoringStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
