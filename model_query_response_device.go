...
// checks if the QueryResponseDevice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryResponseDevice{}
...
type _QueryResponseDevice QueryResponseDevice

// NewQueryResponseDevice instantiates a new QueryResponseDevice object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewQueryResponseDevice(links Links) *QueryResponseDevice {
	this := QueryResponseDevice{}
	this.Links = links
	return &this
}

// NewQueryResponseDeviceWithDefaults instantiates a new QueryResponseDevice object
...
func (o *QueryResponseDevice) UnmarshalJSON(data []byte) (err error) {
	...
	varQueryResponseDevice := _QueryResponseDevice{}

	err = json.Unmarshal(data, &varQueryResponseDevice)

	if err != nil {
		return err
	}

	*o = QueryResponseDevice(varQueryResponseDevice)
...
type NullableQueryResponseDevice struct {
	value *QueryResponseDevice
	isSet bool
}

func (v NullableQueryResponseDevice) Get() *QueryResponseDevice {
	return v.value
}

func (v *NullableQueryResponseDevice) Set(val *QueryResponseDevice) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryResponseDevice) IsSet() bool {
	return v.isSet
}
...
func NewNullableQueryResponseDevice(val *QueryResponseDevice) *NullableQueryResponseDevice {
	return &NullableQueryResponseDevice{value: val, isSet: true}
}
