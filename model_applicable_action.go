...
// checks if the ApplicableAction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicableAction{}
...
func NewApplicableAction() *ApplicableAction {
	this := ApplicableAction{}
	return &this
}

// NewApplicableActionWithDefaults instantiates a new ApplicableAction object
...
func (v NullableApplicableAction) Get() *ApplicableAction {
	return v.value
}

func (v *NullableApplicableAction) Set(val *ApplicableAction) {
	v.value = val
	v.isSet = true
}
...
func NewNullableApplicableAction(val *ApplicableAction) *NullableApplicableAction {
	return &NullableApplicableAction{value: val, isSet: true}
}
