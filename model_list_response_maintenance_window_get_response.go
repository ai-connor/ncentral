...
// checks if the ListResponseMaintenanceWindowGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListResponseMaintenanceWindowGetResponse{}
...
func NewListResponseMaintenanceWindowGetResponse() *ListResponseMaintenanceWindowGetResponse {
	this := ListResponseMaintenanceWindowGetResponse{}
	return &this
}

// NewListResponseMaintenanceWindowGetResponseWithDefaults instantiates a new ListResponseMaintenanceWindowGetResponse object
...
func (o *ListResponseMaintenanceWindowGetResponse) GetData() []MaintenanceWindowGetResponse {
	if o == nil || IsNil(o.Data) {
		var ret []MaintenanceWindowGetResponse
		return ret
	}
	return o.Data
}
...
func (o *ListResponseMaintenanceWindowGetResponse) GetDataOk() ([]MaintenanceWindowGetResponse, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *ListResponseMaintenanceWindowGetResponse) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
func (o *ListResponseMaintenanceWindowGetResponse) SetData(v []MaintenanceWindowGetResponse) {
	o.Data = v
}

// GetTotalItems returns the TotalItems field value if set, zero value otherwise.
func (o *ListResponseMaintenanceWindowGetResponse) GetTotalItems() int32 {
...
func (o *ListResponseMaintenanceWindowGetResponse) HasTotalItems() bool {
	if o != nil && !IsNil(o.TotalItems) {
		return true
	}
...
func (o ListResponseMaintenanceWindowGetResponse) MarshalJSON() ([]byte, error) {
...
type NullableListResponseMaintenanceWindowGetResponse struct {
	value *ListResponseMaintenanceWindowGetResponse
	isSet bool
}

func (v NullableListResponseMaintenanceWindowGetResponse) Get() *ListResponseMaintenanceWindowGetResponse {
	return v.value
}

func (v *NullableListResponseMaintenanceWindowGetResponse) Set(val *ListResponseMaintenanceWindowGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListResponseMaintenanceWindowGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListResponseMaintenanceWindowGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListResponseMaintenanceWindowGetResponse(val *ListResponseMaintenanceWindowGetResponse) *NullableListResponseMaintenanceWindowGetResponse {
	return &NullableListResponseMaintenanceWindowGetResponse{value: val, isSet: true}
}

func (v NullableListResponseMaintenanceWindowGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListResponseMaintenanceWindowGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
