...
// checks if the DefaultCustomPropertyModifyRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DefaultCustomPropertyModifyRequest{}
...
func NewDefaultCustomPropertyModifyRequest() *DefaultCustomPropertyModifyRequest {
	this := DefaultCustomPropertyModifyRequest{}
	return &this
}

// NewDefaultCustomPropertyModifyRequestWithDefaults instantiates a new DefaultCustomPropertyModifyRequest object
...
type NullableDefaultCustomPropertyModifyRequest struct {
	value *DefaultCustomPropertyModifyRequest
	isSet bool
}

func (v NullableDefaultCustomPropertyModifyRequest) Get() *DefaultCustomPropertyModifyRequest {
	return v.value
}

func (v *NullableDefaultCustomPropertyModifyRequest) Set(val *DefaultCustomPropertyModifyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDefaultCustomPropertyModifyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDefaultCustomPropertyModifyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDefaultCustomPropertyModifyRequest(val *DefaultCustomPropertyModifyRequest) *NullableDefaultCustomPropertyModifyRequest {
	return &NullableDefaultCustomPropertyModifyRequest{value: val, isSet: true}
}

func (v NullableDefaultCustomPropertyModifyRequest) MarshalJSON() ([]byte, error) {
