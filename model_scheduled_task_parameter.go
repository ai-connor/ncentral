...
// checks if the ScheduledTaskParameter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduledTaskParameter{}
...
// NewScheduledTaskParameter instantiates a new ScheduledTaskParameter object
...
// NewScheduledTaskParameterWithDefaults instantiates a new ScheduledTaskParameter object
...
type NullableScheduledTaskParameter struct {
	value *ScheduledTaskParameter
	isSet bool
}

func (v NullableScheduledTaskParameter) Get() *ScheduledTaskParameter {
	return v.value
}

func (v *NullableScheduledTaskParameter) Set(val *ScheduledTaskParameter) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduledTaskParameter) IsSet() bool {
	return v.isSet
}
...
func NewNullableScheduledTaskParameter(val *ScheduledTaskParameter) *NullableScheduledTaskParameter {
	return &NullableScheduledTaskParameter{value: val, isSet: true}
}
