...
// checks if the SiteCreated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SiteCreated{}
...
// NewSiteCreatedWithDefaults instantiates a new SiteCreated object
...
func (v NullableSiteCreated) Get() *SiteCreated {
	return v.value
}
...
func NewNullableSiteCreated(val *SiteCreated) *NullableSiteCreated {
	return &NullableSiteCreated{value: val, isSet: true}
}
