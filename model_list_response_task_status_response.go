...
// checks if the ListResponseTaskStatusResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListResponseTaskStatusResponse{}
...
type _ListResponseTaskStatusResponse ListResponseTaskStatusResponse

// NewListResponseTaskStatusResponse instantiates a new ListResponseTaskStatusResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListResponseTaskStatusResponse() *ListResponseTaskStatusResponse {
	this := ListResponseTaskStatusResponse{}
	return &this
}

// NewListResponseTaskStatusResponseWithDefaults instantiates a new ListResponseTaskStatusResponse object
...
func (o *ListResponseTaskStatusResponse) GetData() []TaskStatusResponse {
...
func (o *ListResponseTaskStatusResponse) GetDataOk() ([]TaskStatusResponse, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *ListResponseTaskStatusResponse) SetData(v []TaskStatusResponse) {
	o.Data = v
}
...
func (o *ListResponseTaskStatusResponse) UnmarshalJSON(data []byte) (err error) {
	varListResponseTaskStatusResponse := _ListResponseTaskStatusResponse{}

	err = json.Unmarshal(data, &varListResponseTaskStatusResponse)

	if err != nil {
		return err
	}

	*o = ListResponseTaskStatusResponse(varListResponseTaskStatusResponse)
...
type NullableListResponseTaskStatusResponse struct {
	value *ListResponseTaskStatusResponse
	isSet bool
}

func (v NullableListResponseTaskStatusResponse) Get() *ListResponseTaskStatusResponse {
	return v.value
}

func (v *NullableListResponseTaskStatusResponse) Set(val *ListResponseTaskStatusResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListResponseTaskStatusResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListResponseTaskStatusResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListResponseTaskStatusResponse(val *ListResponseTaskStatusResponse) *NullableListResponseTaskStatusResponse {
	return &NullableListResponseTaskStatusResponse{value: val, isSet: true}
}
