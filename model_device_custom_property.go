...
// checks if the DeviceCustomProperty type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceCustomProperty{}
...
type _DeviceCustomProperty DeviceCustomProperty

// NewDeviceCustomProperty instantiates a new DeviceCustomProperty object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDeviceCustomProperty() *DeviceCustomProperty {
	this := DeviceCustomProperty{}
	return &this
}

// NewDeviceCustomPropertyWithDefaults instantiates a new DeviceCustomProperty object
...
func (o *DeviceCustomProperty) UnmarshalJSON(data []byte) (err error) {
	varDeviceCustomProperty := _DeviceCustomProperty{}

	err = json.Unmarshal(data, &varDeviceCustomProperty)

	if err != nil {
		return err
	}

	*o = DeviceCustomProperty(varDeviceCustomProperty)
...
type NullableDeviceCustomProperty struct {
	value *DeviceCustomProperty
	isSet bool
}

func (v NullableDeviceCustomProperty) Get() *DeviceCustomProperty {
	return v.value
}

func (v *NullableDeviceCustomProperty) Set(val *DeviceCustomProperty) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceCustomProperty) IsSet() bool {
	return v.isSet
}
...
func NewNullableDeviceCustomProperty(val *DeviceCustomProperty) *NullableDeviceCustomProperty {
	return &NullableDeviceCustomProperty{value: val, isSet: true}
}
