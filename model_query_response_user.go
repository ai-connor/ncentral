...
// checks if the QueryResponseUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryResponseUser{}
...
type _QueryResponseUser QueryResponseUser

// NewQueryResponseUser instantiates a new QueryResponseUser object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewQueryResponseUser(links Links) *QueryResponseUser {
	this := QueryResponseUser{}
	this.Links = links
	return &this
}

// NewQueryResponseUserWithDefaults instantiates a new QueryResponseUser object
...
func (o *QueryResponseUser) UnmarshalJSON(data []byte) (err error) {
	...
	varQueryResponseUser := _QueryResponseUser{}

	err = json.Unmarshal(data, &varQueryResponseUser)

	if err != nil {
		return err
	}

	*o = QueryResponseUser(varQueryResponseUser)
...
type NullableQueryResponseUser struct {
	value *QueryResponseUser
	isSet bool
}

func (v NullableQueryResponseUser) Get() *QueryResponseUser {
	return v.value
}

func (v *NullableQueryResponseUser) Set(val *QueryResponseUser) {
	v.value = val
	v.isSet = true
}
...
func NewNullableQueryResponseUser(val *QueryResponseUser) *NullableQueryResponseUser {
	return &NullableQueryResponseUser{value: val, isSet: true}
}
