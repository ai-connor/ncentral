...
// checks if the CustomPsaTicketGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomPsaTicketGetResponse{}
...
func NewCustomPsaTicketGetResponse() *CustomPsaTicketGetResponse {
	this := CustomPsaTicketGetResponse{}
	return &this
}

// NewCustomPsaTicketGetResponseWithDefaults instantiates a new CustomPsaTicketGetResponse object
...
func (o *CustomPsaTicketGetResponse) GetData() CustomPsaTicketInfo {
	if o == nil || IsNil(o.Data) {
		var ret CustomPsaTicketInfo
		return ret
	}
	return *o.Data
}
...
func (o *CustomPsaTicketGetResponse) GetDataOk() (*CustomPsaTicketInfo, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *CustomPsaTicketGetResponse) SetData(v CustomPsaTicketInfo) {
	o.Data = &v
}
...
type NullableCustomPsaTicketGetResponse struct {
	value *CustomPsaTicketGetResponse
	isSet bool
}

func (v NullableCustomPsaTicketGetResponse) Get() *CustomPsaTicketGetResponse {
	return v.value
}

func (v *NullableCustomPsaTicketGetResponse) Set(val *CustomPsaTicketGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomPsaTicketGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomPsaTicketGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomPsaTicketGetResponse(val *CustomPsaTicketGetResponse) *NullableCustomPsaTicketGetResponse {
	return &NullableCustomPsaTicketGetResponse{value: val, isSet: true}
}
