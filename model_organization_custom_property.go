...
// checks if the OrganizationCustomProperty type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationCustomProperty{}
...
func NewOrganizationCustomProperty() *OrganizationCustomProperty {
	this := OrganizationCustomProperty{}
	return &this
}

// NewOrganizationCustomPropertyWithDefaults instantiates a new OrganizationCustomProperty object
...
type NullableOrganizationCustomProperty struct {
	value *OrganizationCustomProperty
	isSet bool
}

func (v NullableOrganizationCustomProperty) Get() *OrganizationCustomProperty {
	return v.value
}

func (v *NullableOrganizationCustomProperty) Set(val *OrganizationCustomProperty) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationCustomProperty) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationCustomProperty) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationCustomProperty(val *OrganizationCustomProperty) *NullableOrganizationCustomProperty {
	return &NullableOrganizationCustomProperty{value: val, isSet: true}
}
