...
// checks if the UserRoleDetailsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserRoleDetailsResponse{}
...
type _UserRoleDetailsResponse UserRoleDetailsResponse

// NewUserRoleDetailsResponse instantiates a new UserRoleDetailsResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewUserRoleDetailsResponse() *UserRoleDetailsResponse {
	this := UserRoleDetailsResponse{}
	return &this
}

// NewUserRoleDetailsResponseWithDefaults instantiates a new UserRoleDetailsResponse object
...
func (o *UserRoleDetailsResponse) GetData() UserRoleDetails {
	if o == nil || IsNil(o.Data) {
		var ret UserRoleDetails
		return ret
	}
	return *o.Data
}
...
func (o *UserRoleDetailsResponse) SetData(v UserRoleDetails) {
	o.Data = &v
}
...
func (o *UserRoleDetailsResponse) UnmarshalJSON(data []byte) (err error) {
	varUserRoleDetailsResponse := _UserRoleDetailsResponse{}

	err = json.Unmarshal(data, &varUserRoleDetailsResponse)

	if err != nil {
		return err
	}

	*o = UserRoleDetailsResponse(varUserRoleDetailsResponse)
...
type NullableUserRoleDetailsResponse struct {
	value *UserRoleDetailsResponse
	isSet bool
}

func (v NullableUserRoleDetailsResponse) Get() *UserRoleDetailsResponse {
	return v.value
}

func (v *NullableUserRoleDetailsResponse) Set(val *UserRoleDetailsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUserRoleDetailsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUserRoleDetailsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserRoleDetailsResponse(val *UserRoleDetailsResponse) *NullableUserRoleDetailsResponse {
	return &NullableUserRoleDetailsResponse{value: val, isSet: true}
}
