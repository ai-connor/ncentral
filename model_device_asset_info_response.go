...
// checks if the DeviceAssetInfoResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceAssetInfoResponse{}
...
func NewDeviceAssetInfoResponse() *DeviceAssetInfoResponse {
	this := DeviceAssetInfoResponse{}
	return &this
}

// NewDeviceAssetInfoResponseWithDefaults instantiates a new DeviceAssetInfoResponse object
...
type NullableDeviceAssetInfoResponse struct {
	value *DeviceAssetInfoResponse
	isSet bool
}

func (v NullableDeviceAssetInfoResponse) Get() *DeviceAssetInfoResponse {
	return v.value
}

func (v *NullableDeviceAssetInfoResponse) Set(val *DeviceAssetInfoResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceAssetInfoResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceAssetInfoResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceAssetInfoResponse(val *DeviceAssetInfoResponse) *NullableDeviceAssetInfoResponse {
	return &NullableDeviceAssetInfoResponse{value: val, isSet: true}
}
