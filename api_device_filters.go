...
func (r ApiListFiltersRequest) Select_(select_ string) ApiListFiltersRequest {
	r.select_ = &select_
	return r
}
...
func (r ApiListFiltersRequest) Execute() (*ListResponseFilter, *http.Response, error) {
...
*/
func (a *DeviceFiltersAPIService) ListFilters(ctx context.Context) ApiListFiltersRequest {
	return ApiListFiltersRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DeviceFiltersAPIService) ListFiltersExecute(r ApiListFiltersRequest) (*ListResponseFilter, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListResponseFilter
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeviceFiltersAPIService.ListFilters")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/device-filters"
	...
	if r.viewScope != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "viewScope", r.viewScope, "form", "")
	}
	if r.pageNumber != nil {
