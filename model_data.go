...
func (o *Data) GetIsPsaCredentialsValid() bool {
	if o == nil || IsNil(o.IsPsaCredentialsValid) {
		var ret bool
		return ret
	}
	return *o.IsPsaCredentialsValid
}

// GetIsPsaCredentialsValidOk returns a tuple with the IsPsaCredentialsValid field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Data) GetIsPsaCredentialsValidOk() (*bool, bool) {
	if o == nil || IsNil(o.IsPsaCredentialsValid) {
		return nil, false
	}
	return o.IsPsaCredentialsValid, true
}
...
func (o Data) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsPsaCredentialsValid) {
		toSerialize["isPsaCredentialsValid"] = o.IsPsaCredentialsValid
	}
...
func (o *Data) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Data(varData)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "isPsaCredentialsValid")
