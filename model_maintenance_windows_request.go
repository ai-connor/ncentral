...
// checks if the MaintenanceWindowsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceWindowsRequest{}
...
func NewMaintenanceWindowsRequest() *MaintenanceWindowsRequest {
	this := MaintenanceWindowsRequest{}
	return &this
}

// NewMaintenanceWindowsRequestWithDefaults instantiates a new MaintenanceWindowsRequest object
...
func (o *MaintenanceWindowsRequest) GetMaintenanceWindows() []MaintenanceWindowRequest {
	if o == nil || IsNil(o.MaintenanceWindows) {
		var ret []MaintenanceWindowRequest
		return ret
	}
...
type NullableMaintenanceWindowsRequest struct {
	value *MaintenanceWindowsRequest
	isSet bool
}

func (v NullableMaintenanceWindowsRequest) Get() *MaintenanceWindowsRequest {
	return v.value
}

func (v *NullableMaintenanceWindowsRequest) Set(val *MaintenanceWindowsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceWindowsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceWindowsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceWindowsRequest(val *MaintenanceWindowsRequest) *NullableMaintenanceWindowsRequest {
	return &NullableMaintenanceWindowsRequest{value: val, isSet: true}
}
