...
func (r ApiListUsersRequest) Execute() (*QueryResponseUser, *http.Response, error) {
...
func (a *UsersAPIService) ListUsersExecute(r ApiListUsersRequest) (*QueryResponseUser, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *QueryResponseUser
	)
	...
	localVarPath := localBasePath + "/api/org-units/{orgUnitId}/users"
...
func (r ApiUserRootRequest) Execute() (*LinksResponse, *http.Response, error) {
	return r.ApiService.UserRootExecute(r)
}
...
*/
func (a *UsersAPIService) UserRoot(ctx context.Context) ApiUserRootRequest {
	return ApiUserRootRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *UsersAPIService) UserRootExecute(r ApiUserRootRequest) (*LinksResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersAPIService.UserRoot")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
