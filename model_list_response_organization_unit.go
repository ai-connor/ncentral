...
// checks if the ListResponseOrganizationUnit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListResponseOrganizationUnit{}
...
type _ListResponseOrganizationUnit ListResponseOrganizationUnit

// NewListResponseOrganizationUnit instantiates a new ListResponseOrganizationUnit object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListResponseOrganizationUnit() *ListResponseOrganizationUnit {
	this := ListResponseOrganizationUnit{}
	return &this
}

// NewListResponseOrganizationUnitWithDefaults instantiates a new ListResponseOrganizationUnit object
...
func (o *ListResponseOrganizationUnit) GetData() []OrganizationUnit {
...
func (o *ListResponseOrganizationUnit) GetDataOk() ([]OrganizationUnit, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *ListResponseOrganizationUnit) SetData(v []OrganizationUnit) {
	o.Data = v
}
...
func (o *ListResponseOrganizationUnit) UnmarshalJSON(data []byte) (err error) {
	varListResponseOrganizationUnit := _ListResponseOrganizationUnit{}

	err = json.Unmarshal(data, &varListResponseOrganizationUnit)

	if err != nil {
		return err
	}

	*o = ListResponseOrganizationUnit(varListResponseOrganizationUnit)
...
type NullableListResponseOrganizationUnit struct {
	value *ListResponseOrganizationUnit
	isSet bool
}

func (v NullableListResponseOrganizationUnit) Get() *ListResponseOrganizationUnit {
	return v.value
}

func (v *NullableListResponseOrganizationUnit) Set(val *ListResponseOrganizationUnit) {
	v.value = val
	v.isSet = true
}

func (v NullableListResponseOrganizationUnit) IsSet() bool {
	return v.isSet
}

func (v *NullableListResponseOrganizationUnit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListResponseOrganizationUnit(val *ListResponseOrganizationUnit) *NullableListResponseOrganizationUnit {
	return &NullableListResponseOrganizationUnit{value: val, isSet: true}
}
