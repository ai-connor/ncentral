...
// checks if the ListResponseFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListResponseFilter{}
...
func NewListResponseFilter() *ListResponseFilter {
	this := ListResponseFilter{}
	return &this
}

// NewListResponseFilterWithDefaults instantiates a new ListResponseFilter object
...
func (v NullableListResponseFilter) Get() *ListResponseFilter {
	return v.value
}

func (v *NullableListResponseFilter) Set(val *ListResponseFilter) {
	v.value = val
	v.isSet = true
}
...
func NewNullableListResponseFilter(val *ListResponseFilter) *NullableListResponseFilter {
	return &NullableListResponseFilter{value: val, isSet: true}
}
