...
func (r ApiListTasksForDeviceRequest) Execute() (*ListResponseTaskStatusResponse, *http.Response, error) {
	return r.ApiService.ListTasksForDeviceExecute(r)
}
...
func (a *DeviceTasksAPIService) ListTasksForDeviceExecute(r ApiListTasksForDeviceRequest) (*ListResponseTaskStatusResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListResponseTaskStatusResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeviceTasksAPIService.ListTasksForDevice")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/devices/{deviceId}/scheduled-tasks"
