...
// checks if the ListResponseOrganizationCustomProperty type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListResponseOrganizationCustomProperty{}
...
func NewListResponseOrganizationCustomProperty() *ListResponseOrganizationCustomProperty {
	this := ListResponseOrganizationCustomProperty{}
	return &this
}

// NewListResponseOrganizationCustomPropertyWithDefaults instantiates a new ListResponseOrganizationCustomProperty object
...
func (o *ListResponseOrganizationCustomProperty) GetData() []OrganizationCustomProperty {
	if o == nil || IsNil(o.Data) {
		var ret []OrganizationCustomProperty
		return ret
	}
	return o.Data
}
...
func (o *ListResponseOrganizationCustomProperty) GetDataOk() ([]OrganizationCustomProperty, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *ListResponseOrganizationCustomProperty) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
func (o *ListResponseOrganizationCustomProperty) SetData(v []OrganizationCustomProperty) {
	o.Data = v
}
...
type NullableListResponseOrganizationCustomProperty struct {
	value *ListResponseOrganizationCustomProperty
	isSet bool
}

func (v NullableListResponseOrganizationCustomProperty) Get() *ListResponseOrganizationCustomProperty {
	return v.value
}

func (v *NullableListResponseOrganizationCustomProperty) Set(val *ListResponseOrganizationCustomProperty) {
	v.value = val
	v.isSet = true
}

func (v NullableListResponseOrganizationCustomProperty) IsSet() bool {
	return v.isSet
}

func (v *NullableListResponseOrganizationCustomProperty) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListResponseOrganizationCustomProperty(val *ListResponseOrganizationCustomProperty) *NullableListResponseOrganizationCustomProperty {
	return &NullableListResponseOrganizationCustomProperty{value: val, isSet: true}
}

func (v NullableListResponseOrganizationCustomProperty) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListResponseOrganizationCustomProperty) UnmarshalJSON(src []byte) error {
	v.isSet = true
