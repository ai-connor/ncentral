...
// checks if the VersionInfoResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VersionInfoResponse{}
...
func NewVersionInfoResponse() *VersionInfoResponse {
	this := VersionInfoResponse{}
	return &this
}

// NewVersionInfoResponseWithDefaults instantiates a new VersionInfoResponse object
...
func (v NullableVersionInfoResponse) Get() *VersionInfoResponse {
	return v.value
}

func (v *NullableVersionInfoResponse) Set(val *VersionInfoResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVersionInfoResponse) IsSet() bool {
	return v.isSet
}
...
func NewNullableVersionInfoResponse(val *VersionInfoResponse) *NullableVersionInfoResponse {
	return &NullableVersionInfoResponse{value: val, isSet: true}
}
