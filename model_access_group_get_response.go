...
// checks if the AccessGroupGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessGroupGetResponse{}
...
func NewAccessGroupGetResponse() *AccessGroupGetResponse {
	this := AccessGroupGetResponse{}
	return &this
}

// NewAccessGroupGetResponseWithDefaults instantiates a new AccessGroupGetResponse object
...
func (o *AccessGroupGetResponse) GetData() AccessGroupDetails {
	if o == nil || IsNil(o.Data) {
		var ret AccessGroupDetails
		return ret
	}
	return *o.Data
}
...
func (o *AccessGroupGetResponse) SetData(v AccessGroupDetails) {
	o.Data = &v
}
...
type NullableAccessGroupGetResponse struct {
	value *AccessGroupGetResponse
	isSet bool
}

func (v NullableAccessGroupGetResponse) Get() *AccessGroupGetResponse {
	return v.value
}

func (v *NullableAccessGroupGetResponse) Set(val *AccessGroupGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessGroupGetResponse) IsSet() bool {
	return v.isSet
}
...
func NewNullableAccessGroupGetResponse(val *AccessGroupGetResponse) *NullableAccessGroupGetResponse {
	return &NullableAccessGroupGetResponse{value: val, isSet: true}
}
