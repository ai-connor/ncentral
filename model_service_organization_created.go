...
// checks if the ServiceOrganizationCreated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceOrganizationCreated{}
...
func NewServiceOrganizationCreated() *ServiceOrganizationCreated {
	this := ServiceOrganizationCreated{}
	return &this
}

// NewServiceOrganizationCreatedWithDefaults instantiates a new ServiceOrganizationCreated object
...
type NullableServiceOrganizationCreated struct {
	value *ServiceOrganizationCreated
	isSet bool
}

func (v NullableServiceOrganizationCreated) Get() *ServiceOrganizationCreated {
	return v.value
}

func (v *NullableServiceOrganizationCreated) Set(val *ServiceOrganizationCreated) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceOrganizationCreated) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceOrganizationCreated) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceOrganizationCreated(val *ServiceOrganizationCreated) *NullableServiceOrganizationCreated {
	return &NullableServiceOrganizationCreated{value: val, isSet: true}
}
