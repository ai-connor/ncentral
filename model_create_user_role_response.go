...
// checks if the CreateUserRoleResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateUserRoleResponse{}
...
func NewCreateUserRoleResponse() *CreateUserRoleResponse {
	this := CreateUserRoleResponse{}
	return &this
}

// NewCreateUserRoleResponseWithDefaults instantiates a new CreateUserRoleResponse object
...
type NullableCreateUserRoleResponse struct {
	value *CreateUserRoleResponse
	isSet bool
}

func (v NullableCreateUserRoleResponse) Get() *CreateUserRoleResponse {
	return v.value
}

func (v *NullableCreateUserRoleResponse) Set(val *CreateUserRoleResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateUserRoleResponse) IsSet() bool {
	return v.isSet
}
...
func NewNullableCreateUserRoleResponse(val *CreateUserRoleResponse) *NullableCreateUserRoleResponse {
	return &NullableCreateUserRoleResponse{value: val, isSet: true}
}
