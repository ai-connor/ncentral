...
func (o *RegistrationToken) GetRegistrationTokenExpiryDate() string {
	if o == nil || IsNil(o.RegistrationTokenExpiryDate) {
		var ret string
		return ret
	}
	return *o.RegistrationTokenExpiryDate
}

// GetRegistrationTokenExpiryDateOk returns a tuple with the RegistrationTokenExpiryDate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RegistrationToken) GetRegistrationTokenExpiryDateOk() (*string, bool) {
	if o == nil || IsNil(o.RegistrationTokenExpiryDate) {
		return nil, false
	}
	return o.RegistrationTokenExpiryDate, true
}
...
func (o *RegistrationToken) SetRegistrationTokenExpiryDate(v string) {
	o.RegistrationTokenExpiryDate = &v
}
