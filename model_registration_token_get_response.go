...
// checks if the RegistrationTokenGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegistrationTokenGetResponse{}
...
type _RegistrationTokenGetResponse RegistrationTokenGetResponse

// NewRegistrationTokenGetResponse instantiates a new RegistrationTokenGetResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRegistrationTokenGetResponse() *RegistrationTokenGetResponse {
	this := RegistrationTokenGetResponse{}
	return &this
}

// NewRegistrationTokenGetResponseWithDefaults instantiates a new RegistrationTokenGetResponse object
...
func (o *RegistrationTokenGetResponse) GetData() RegistrationToken {
	if o == nil || IsNil(o.Data) {
		var ret RegistrationToken
		return ret
	}
	return *o.Data
}
...
func (o *RegistrationTokenGetResponse) GetDataOk() (*RegistrationToken, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *RegistrationTokenGetResponse) SetData(v RegistrationToken) {
	o.Data = &v
}
...
func (o *RegistrationTokenGetResponse) UnmarshalJSON(data []byte) (err error) {
	varRegistrationTokenGetResponse := _RegistrationTokenGetResponse{}

	err = json.Unmarshal(data, &varRegistrationTokenGetResponse)

	if err != nil {
		return err
	}

	*o = RegistrationTokenGetResponse(varRegistrationTokenGetResponse)
...
type NullableRegistrationTokenGetResponse struct {
	value *RegistrationTokenGetResponse
	isSet bool
}

func (v NullableRegistrationTokenGetResponse) Get() *RegistrationTokenGetResponse {
	return v.value
}

func (v *NullableRegistrationTokenGetResponse) Set(val *RegistrationTokenGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRegistrationTokenGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRegistrationTokenGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegistrationTokenGetResponse(val *RegistrationTokenGetResponse) *NullableRegistrationTokenGetResponse {
	return &NullableRegistrationTokenGetResponse{value: val, isSet: true}
}
