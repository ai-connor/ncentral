...
// checks if the OrganizationPropertyUpdated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationPropertyUpdated{}
...
func NewOrganizationPropertyUpdated() *OrganizationPropertyUpdated {
	this := OrganizationPropertyUpdated{}
	return &this
}

// NewOrganizationPropertyUpdatedWithDefaults instantiates a new OrganizationPropertyUpdated object
...
type NullableOrganizationPropertyUpdated struct {
	value *OrganizationPropertyUpdated
	isSet bool
}

func (v NullableOrganizationPropertyUpdated) Get() *OrganizationPropertyUpdated {
	return v.value
}

func (v *NullableOrganizationPropertyUpdated) Set(val *OrganizationPropertyUpdated) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationPropertyUpdated) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationPropertyUpdated) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationPropertyUpdated(val *OrganizationPropertyUpdated) *NullableOrganizationPropertyUpdated {
	return &NullableOrganizationPropertyUpdated{value: val, isSet: true}
}
