...
// checks if the MaintenanceWindowsDeleteRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceWindowsDeleteRequest{}
...
// NewMaintenanceWindowsDeleteRequest instantiates a new MaintenanceWindowsDeleteRequest object
...
func NewMaintenanceWindowsDeleteRequest(scheduleIds []int32) *MaintenanceWindowsDeleteRequest {
	this := MaintenanceWindowsDeleteRequest{}
	this.ScheduleIds = scheduleIds
	return &this
}

// NewMaintenanceWindowsDeleteRequestWithDefaults instantiates a new MaintenanceWindowsDeleteRequest object
...
// GetScheduleIdsOk returns a tuple with the ScheduleIds field value
// and a boolean to check if the value has been set.
func (o *MaintenanceWindowsDeleteRequest) GetScheduleIdsOk() ([]int32, bool) {
	if o == nil {
		return nil, false
	}
	return o.ScheduleIds, true
}
...
type NullableMaintenanceWindowsDeleteRequest struct {
	value *MaintenanceWindowsDeleteRequest
	isSet bool
}

func (v NullableMaintenanceWindowsDeleteRequest) Get() *MaintenanceWindowsDeleteRequest {
	return v.value
}

func (v *NullableMaintenanceWindowsDeleteRequest) Set(val *MaintenanceWindowsDeleteRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceWindowsDeleteRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceWindowsDeleteRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceWindowsDeleteRequest(val *MaintenanceWindowsDeleteRequest) *NullableMaintenanceWindowsDeleteRequest {
	return &NullableMaintenanceWindowsDeleteRequest{value: val, isSet: true}
}
