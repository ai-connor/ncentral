...
func (r ApiListJobStatusesRequest) Execute() (*ListResponse, *http.Response, error) {
...
//  @return ListResponse
func (a *JobStatusesAPIService) ListJobStatusesExecute(r ApiListJobStatusesRequest) (*ListResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "JobStatusesAPIService.ListJobStatuses")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/org-units/{orgUnitId}/job-statuses"
