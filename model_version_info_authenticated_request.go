...
// checks if the VersionInfoAuthenticatedRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VersionInfoAuthenticatedRequest{}
...
func NewVersionInfoAuthenticatedRequest() *VersionInfoAuthenticatedRequest {
	this := VersionInfoAuthenticatedRequest{}
	return &this
}

// NewVersionInfoAuthenticatedRequestWithDefaults instantiates a new VersionInfoAuthenticatedRequest object
...
type NullableVersionInfoAuthenticatedRequest struct {
	value *VersionInfoAuthenticatedRequest
	isSet bool
}

func (v NullableVersionInfoAuthenticatedRequest) Get() *VersionInfoAuthenticatedRequest {
	return v.value
}

func (v *NullableVersionInfoAuthenticatedRequest) Set(val *VersionInfoAuthenticatedRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableVersionInfoAuthenticatedRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableVersionInfoAuthenticatedRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVersionInfoAuthenticatedRequest(val *VersionInfoAuthenticatedRequest) *NullableVersionInfoAuthenticatedRequest {
	return &NullableVersionInfoAuthenticatedRequest{value: val, isSet: true}
}
