...
// checks if the ListResponseSite type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListResponseSite{}
...
func NewListResponseSite() *ListResponseSite {
	this := ListResponseSite{}
	return &this
}

// NewListResponseSiteWithDefaults instantiates a new ListResponseSite object
...
type NullableListResponseSite struct {
	value *ListResponseSite
	isSet bool
}

func (v NullableListResponseSite) Get() *ListResponseSite {
	return v.value
}

func (v *NullableListResponseSite) Set(val *ListResponseSite) {
	v.value = val
	v.isSet = true
}
...
func NewNullableListResponseSite(val *ListResponseSite) *NullableListResponseSite {
	return &NullableListResponseSite{value: val, isSet: true}
}
