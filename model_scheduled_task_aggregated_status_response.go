...
// checks if the ScheduledTaskAggregatedStatusResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduledTaskAggregatedStatusResponse{}
...
func NewScheduledTaskAggregatedStatusResponse() *ScheduledTaskAggregatedStatusResponse {
	this := ScheduledTaskAggregatedStatusResponse{}
	return &this
}

// NewScheduledTaskAggregatedStatusResponseWithDefaults instantiates a new ScheduledTaskAggregatedStatusResponse object
...
func (o *ScheduledTaskAggregatedStatusResponse) GetData() TaskAggregatedStatus {
	if o == nil || IsNil(o.Data) {
		var ret TaskAggregatedStatus
		return ret
	}
	return *o.Data
}
...
func (o *ScheduledTaskAggregatedStatusResponse) GetDataOk() (*TaskAggregatedStatus, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *ScheduledTaskAggregatedStatusResponse) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
func (o *ScheduledTaskAggregatedStatusResponse) SetData(v TaskAggregatedStatus) {
	o.Data = &v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *ScheduledTaskAggregatedStatusResponse) GetLinks() map[string]string {
...
func (o *ScheduledTaskAggregatedStatusResponse) HasLinks() bool {
	if o != nil && !IsNil(o.Links) {
		return true
	}
...
func (o *ScheduledTaskAggregatedStatusResponse) SetLinks(v map[string]string) {
	o.Links = &v
}
...
type NullableScheduledTaskAggregatedStatusResponse struct {
	value *ScheduledTaskAggregatedStatusResponse
	isSet bool
}

func (v NullableScheduledTaskAggregatedStatusResponse) Get() *ScheduledTaskAggregatedStatusResponse {
	return v.value
}

func (v *NullableScheduledTaskAggregatedStatusResponse) Set(val *ScheduledTaskAggregatedStatusResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduledTaskAggregatedStatusResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduledTaskAggregatedStatusResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduledTaskAggregatedStatusResponse(val *ScheduledTaskAggregatedStatusResponse) *NullableScheduledTaskAggregatedStatusResponse {
	return &NullableScheduledTaskAggregatedStatusResponse{value: val, isSet: true}
}

func (v NullableScheduledTaskAggregatedStatusResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduledTaskAggregatedStatusResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
